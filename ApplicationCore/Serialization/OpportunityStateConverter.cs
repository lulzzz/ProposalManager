...
namespace ApplicationCore.Serialization
{
    ...
    /// </summary>
    public class OpportunityStateConverter : JsonConverter
    {
        /// <summary>
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            else if (value is OpportunityState)
            {
                var testVar = value.ToString();
                var role = (OpportunityState)value;
            ...
            {
                throw new JsonSerializationException("Expected OpportunityState object value");
            }
        }

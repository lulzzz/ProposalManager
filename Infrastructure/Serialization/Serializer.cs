...
namespace Infrastructure.Serialization
{
    public class Serializer
    {
        ...
        {
            Guard.Against.Null(jsonSerializerSettings, nameof(jsonSerializerSettings));
        ...
        public T DeserializeObject<T>(string inputString)
        {
            ...
            return JsonConvert.DeserializeObject<T>(inputString, _jsonSerializerSettings);
        }
        ...
        public string SerializeObject(object serializeableObject)
        {
            ...
            return JsonConvert.SerializeObject(serializeableObject, _jsonSerializerSettings);
        }
    }
}
